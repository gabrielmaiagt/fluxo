      ...
      <div className="w-full max-w-sm mx-auto flex flex-col items-center z-10">
        ...
        <main className="w-full flex flex-col gap-4">
          ...
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-4 w-full flex flex-col">
            ...
            <Link href="https://fluxodeoferta.site/fluxo" target="_blank" rel="noopener noreferrer" className="my-4 block overflow-hidden rounded-lg shadow-lg shadow-red-glow transition-shadow duration-300 hover:shadow-destructive/80">
              <Image
          ...
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-4 w-full">
            ...
            <div className="flex flex-col gap-3 mt-4">
              <Link href="https://chat.whatsapp.com/Khh4Ulvu9elLgZvHjGWItX" target="_blank" rel="noopener noreferrer" className="block rounded-lg overflow-hidden transition-transform duration-300 hover:scale-105 shadow-lg shadow-red-glow hover:shadow-destructive/80">
                <Image 
              ...
              <Link href="https://discord.gg/N22CvMkpUV" target="_blank" rel="noopener noreferrer" className="block rounded-lg overflow-hidden transition-transform duration-300 hover:scale-105 shadow-lg shadow-red-glow hover:shadow-destructive/80">
                <Image 
              ...
              <Link href="https://www.instagram.com/gabrielmaiagt/" target="_blank" rel="noopener noreferrer" className="block rounded-lg overflow-hidden transition-transform duration-300 hover:scale-105 w-full shadow-lg shadow-red-glow hover:shadow-destructive/80">
                <Image 
